import { Commander, QueryState, Query, Selection, Injector, QueryStateType } from '@textbus/core'
import { SelectTool, SelectToolConfig } from '../../toolkit/select-tool'
import { I18n, createCodeSlot } from '@textbus/editor'
import { preComponent } from '@/editor'
