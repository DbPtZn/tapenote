...
// const isStrIcon = typeof props.icon === 'string'
...
<template>
  <n-icon :size="size" :depth="depth" :color="color" :component="typeof icon === 'string' ? undefined : icon">
    <span v-if="typeof props.icon === 'string'" :material="material" :class="[typeof props.icon === 'string' && icon, 'icon', rotateVal && 'rotate']"></span>
  </n-icon>
</template>
