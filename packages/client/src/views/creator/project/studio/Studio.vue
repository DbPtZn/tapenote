...
import { Character, AudioFragment, TTS, ASR, TipBtn, StudioToolbar } from './private'
import useStore from '@/store'
import { VNode, computed, h, inject, nextTick, onMounted, onUnmounted, reactive, ref, useTemplateRef, watch } from 'vue'
import { useResizeObserver } from '@vueuse/core'
import {  DropdownOption, MenuOption, NIcon, PopoverInst, useDialog, useMessage, useThemeVars } from 'naive-ui'
import { Bridge } from '../bridge'
import _ from 'lodash'
import utils from '@/utils'
import { useFragment, usePromoter, useInput, useTrash } from './hooks'
import { Subscription, auditTime } from '@tanbo/stream'
import { LibraryEnum } from '@/enums'
import { Voice, Delete, CommentAdd, FileImport, TextT24Filled } from '@/components'
import { collapseText } from './_utils'
