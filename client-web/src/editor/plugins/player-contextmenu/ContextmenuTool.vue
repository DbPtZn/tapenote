...
import { Commander, ComponentInstance, ContentType, Injector, Renderer, RootComponentRef, Slot, Subscription } from '@textbus/core'
import { computed, inject, nextTick, onUnmounted, reactive, ref } from 'vue'
import { AnimeEventService, RootEventService } from '../../services'
import { Layout } from '@textbus/editor'
// import { AnimeEffectMap } from '../../common/_index'
import { UIIcon, UIConfig } from '@/editor'
import { ANIME_COMPONENT_NAME, AnimeUtilsProvider, ConfigProvider, Player, animeComponent } from '@/editor'
