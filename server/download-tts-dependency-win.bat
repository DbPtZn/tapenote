...
REM 定义变量
set download_filename="vits-zh-hf-fanchen-C.tar.bz2"
set download_source="https://github.com/k2-fsa/sherpa-onnx/releases/download/tts-models"
...
echo "tts 模型文件已下载成功，但7-Zip 和 bzip2 都未安装，自动解压文件失败，请手动解压文件。"
pause
exit /b
